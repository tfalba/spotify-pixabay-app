 ...
 export function useSectionClass(isLight: boolean, colNum: number = 2) {
  return clsx(
    "xl:col-span-1 flex min-w-0 flex-col rounded-3xl md:border-thick p-4 shadow-glow min-h-auto max-h-[max(600px,calc(100vh-12rem))] lg:min-h-[calc(100vh-12rem)] overflow-y-scroll transition-colors duration-300",
