...
export function useSectionClass(_isLight: boolean, colNum: number = 2) {
  ...
  return clsx(
    ...
    colNum === 1 && `min-h-[max(520px,calc(100vh-17rem))] max-h-[min(200vw,max(520px,calc(100vh-17rem)))] px-1 py-2`,
    colNum === 2 && `min-h-[max(520px,calc(100vh-17rem))] max-h-[min(200vw,max(520px,calc(100vh-17rem)))] p-4`,
    colNum === 3 && `min-h-[max(520px,calc(100vh-17rem))] max-h-[min(200vw,max(520px,calc(100vh-17rem)))] p-4`
  );
}
